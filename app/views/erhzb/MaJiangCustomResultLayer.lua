...
local MaJiangCustomResultLayer = class("MaJiangCustomResultLayer", cc.load("mvc").DialogBase)
MaJiangCustomResultLayer.RESOURCE_FILENAME = "game_erhzb/custom_result_layer.csb"
...
function MaJiangCustomResultLayer:onCreate(data) 
    print("MaJiangCustomResultLayer:onCreate(data).............", data)
...
return MaJiangCustomResultLayer
